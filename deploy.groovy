                ...
                script {
                    ...
                    withCredentials([file(credentialsId: 'SERVER_KEY', variable: 'JWT_KEY')]) {
                        ...
                        if(deploy == 'true') {
                            ...
                            bat """
                                sf config set org-instance-url=https:00D7R0000047XLo!AR0AQC0GgilI3xNcLgyd3lQKMg92Zb3GKH2DV0MrNJ2nUienO4B9qYaRGT3.2xfC1lmYMOeSAXJo1pRaktRSbPErlH3RQs3B --global
                            """
                            bat """
